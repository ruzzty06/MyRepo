Namespace My
    ...
    ''' </summary>
    ''' <remarks>
    ''' I did one Dialog using CreateLineBreaks to show that you can be
    ''' a tad lazy in how to create multiple lines of text in a dialog.
    ''' All the others could easy include this too.
    ''' </remarks>
    ...
    Partial Friend Class _Dialogs
        ...
        Private Function CreateLineBreaks(ByVal Text As String) As String
            If String.IsNullOrEmpty(LineBreakChar) Then
                Return Text
            Else
        ...
        Public Sub InformationDialog(ByVal Text As String)
            MessageBox.Show(CreateLineBreaks(Text), My.Application.Info.Title, MessageBoxButtons.OK, MessageBoxIcon.Information)
        End Sub
        ''' <summary>
        ''' Shows text in dialog with information icon
        ''' </summary>
